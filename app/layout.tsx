...
export const metadata = {
  title: 'Juan Manuel Ibarlucea | Full Stack Developer',
  description: 'Juan is a full-stack developer with 5+ years if experience.',
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.className} bg-gray- text-gray-950 pt-28 sm:pt-36`}
      >
