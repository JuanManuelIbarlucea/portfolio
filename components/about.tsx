...
export default function About() {
  ...
  return (
    <motion.section
      ref={ref}
      className="mb-28 max-w-[45rem] text-center leading-8 sm:m-0 scroll-mt-36"
    ...
    >
      ...
      <p>
        ...
        versatility to my technical arsenal.
        <br />
        <br />
        ...
        penchant for <span className="font-bold">clear communication</span> is
        the cornerstone of my collaborative prowess, enabling me to seamlessly
        blend into team dynamics while also excelling autonomously. Beyond the
        code, I am driven by a{' '}
        <span className="font-bold">relentless desire for growth</span>.
        Evolving alongside the ever-shifting technological landscape is
        ingrained in my DNA.
        <br />
        <br />
